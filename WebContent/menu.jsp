...
<head>
	...
	*{margin: 0;padding: 0}
	...
	.list{width: 210px;border-bottom:solid 1px #316a91;margin:40px auto 0 auto;float:left;}
	...
	<script type="text/javascript" src="/show/js/jquery/2.0.0/jquery.min.js"></script>
