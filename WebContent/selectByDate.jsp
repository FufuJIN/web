...
<body>
				...
				<ul class="yiji">
					...
					<li><a href="#" class="inactive" id='location_menu'>数据中心<span class="glyphicon glyphicon-plus" style='float:right bottom;'></span></a>
						<ul style="display:block">
						    <li><a href="/show/selectByDate.jsp" class='active'>查询数据</a></li> 
    ...
    <div id="content">
    <form>
                 开始时间: <input type="date" name="beginday" id="beginday">
                结束时间: <input type="date" name="overday" id="overday">          
            <button type="button" onclick="displayEcharts()">查询</button> 
    </form>
     <div id="main" style="width: 600px;height:400px;float:right bottom;"></div>
     <script type="text/javascript">
        // 基于准备好的dom，初始化echarts实例
        function displayEcharts(){
    ...
    <!-- 
            结束时间: <input type="date" name="overday">
    -->
</body>
</html>